  ...
  return (
    <>
      <nav className="w-full h-16 p-3 bg-white flex items-center justify-between px-4 border-b border-gray-300 shadow-md md:hidden sticky top-0 z-50">
        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            <span className="text-xs text-teal-600 absolute -bottom-2 right-0">
              eCommerce
            </span>
          </div>
        </Link>
      ...
      <form
        ...
        className="md:hidden w-full px-4 py-2.5 flex justify-between items-center bg-white shadow-md border-t border-gray-300"
      >
        <input
          type="text"
          value={searchQuery}
