  ...
  const slides = [
    {
      ...
      buttonText: "Shop Now",
      backgroundColor: "bg-gradient-to-r from-[#FFDEE9] to-[#B5FFFC]",
      overlay: "bg-black/40",
    },
    {
      image: heroImage3,
      ...
      backgroundColor: "bg-gradient-to-r from-[#C6FFDD] to-[#FBD786]",
      overlay: "bg-black/30",
    },
    {
      image: heroImage2,
      ...
      backgroundColor: "bg-gradient-to-r from-[#D4FC79] to-[#96E6A1]",
      overlay: "bg-black/30",
    },
  ];
  ...
  return (
    <div className="relative">
      ...
      >
          ...
          <SwiperSlide key={index}>
            ...
            >
              ...
              <div className="relative z-20 text-white flex flex-col justify-center items-center lg:items-start pt-10 lg:pt-0 text-center lg:text-left">
                ...
                <button
                  className="px-6 sm:px-8 py-2 lg:py-3 rounded-full bg-[#FFC107] text-black font-semibold shadow-lg hover:bg-[#FFB300] transition duration-300 text-sm md:text-base"
                  onClick={() => {
                    navigate("/products");
                  }}
                >
              ...
              {/* Image Section */}
              <div className="relative w-full lg:w-1/2 h-full flex justify-center lg:justify-end items-center z-10">
                <img
                  src={slide.image}
                  alt={slide.title}
        ...
        {/* Navigation Arrows */}
        <div className="swiper-button-prev-hero text-white rounded-full w-8 h-8 md:w-10 md:h-10 flex items-center justify-center absolute left-4 top-1/2 transform -translate-y-1/2 z-20 bg-black/50 hover:bg-black">
          <FaArrowLeft />
        </div>
        <div className="swiper-button-next-hero text-white rounded-full w-8 h-8 md:w-10 md:h-10 flex items-center justify-center absolute right-4 top-1/2 transform -translate-y-1/2 z-20 bg-black/50 hover:bg-black">
          <FaArrowRight />
        </div>
      </Swiper>
    </div>
